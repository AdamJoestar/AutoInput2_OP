...
FIELD_DEFINITIONS = {
    ...
    "TEXT9": {"placeholder": "[TEXT9]", "label": "Ensayo térmico realizado en", "type": "dropdown", "options": []},
    ...
    "OBSER1": {"placeholder": "[OBSER1]", "label": "Código 1", "type": "dropdown", "options": []},
    ...
    "OBSER2": {"placeholder": "[OBSER2]", "label": "Código 2", "type": "dropdown", "options": []},
    ...
    "OBSER3": {"placeholder": "[OBSER3]", "label": "Código 3", "type": "dropdown", "options": []},
    ...
    "OBSER4": {"placeholder": "[OBSER4]", "label": "Código 4", "type": "dropdown", "options": []},
    ...
    "OBSER5": {"placeholder": "[OBSER5]", "label": "Código 5", "type": "dropdown", "options": []},
    ...
    "OBSER6": {"placeholder": "[OBSER6]", "label": "Código 6", "type": "dropdown", "options": []},
    ...
    "OBSER7": {"placeholder": "[OBSER7]", "label": "Código 7", "type": "dropdown", "options": []},
    ...
    "OBSER8": {"placeholder": "[OBSER8]", "label": "Código 8", "type": "dropdown", "options": []},
    ...
    "OBSER9": {"placeholder": "[OBSER9]", "label": "Código 9", "type": "dropdown", "options": []},
    ...
    "OBSER10": {"placeholder": "[OBSER10]", "label": "Código 10", "type": "dropdown", "options": []},
    ...
    "OBSER11": {"placeholder": "[OBSER11]", "label": "Código 11", "type": "dropdown", "options": []},
    ...
    "OBSER12": {"placeholder": "[OBSER12]", "label": "Código 12", "type": "dropdown", "options": []},
    ...
    "UNIDAD_RES1": {"placeholder": "[UNIDAD_RES1]", "label": "Unidad 1", "type": "text"},
    ...
    "UNIDAD_RES2": {"placeholder": "[UNIDAD_RES2]", "label": "Unidad 2", "type": "text"},
    ...
    "UNIDAD_RES3": {"placeholder": "[UNIDAD_RES3]", "label": "Unidad 3", "type": "text"},
    ...
    "UNIDAD_RES4": {"placeholder": "[UNIDAD_RES4]", "label": "Unidad 4", "type": "text"},
    ...
    "UNIDAD_RES5": {"placeholder": "[UNIDAD_RES5]", "label": "Unidad 5", "type": "text"},
    ...
    "UNIDAD_RES6": {"placeholder": "[UNIDAD_RES6]", "label": "Unidad 6", "type": "text"},
    ...
    "UNIDAD_RES7": {"placeholder": "[UNIDAD_RES7]", "label": "Unidad 7", "type": "text"},
    ...
    "UNIDAD_RES8": {"placeholder": "[UNIDAD_RES8]", "label": "Unidad 8", "type": "text"},
    ...
    "UNIDAD_RES9": {"placeholder": "[UNIDAD_RES9]", "label": "Unidad 9", "type": "text"},
    ...
    "UNIDAD_RES10": {"placeholder": "[UNIDAD_RES10]", "label": "Unidad 10", "type": "text"},
